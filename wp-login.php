...
switch ( $action ) {
	...
	<p>
		<label for="user_login"><?php _e( '用户名或电子邮件地址' ); ?><br/>
	...
	<p style="text-align: center"><a class="return" href="<?php echo esc_url( home_url( '/' ) ); ?>">
		<?php
		/* translators: %s: site title */
		printf( _x( '&larr; 返回 %s', 'site' ), get_bloginfo( 'title', 'display' ) );
		?>
	</a></p>
	...
	<p id="nav">
			...
			if ( ! isset( $_GET['checkemail'] ) || ! in_array( $_GET['checkemail'], array( 'confirm', 'newpass' ) ) ) :
				...
				?>
		<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php _e( '忘记密码?' ); ?></a>
			<?php endif; ?>
	</p>
	<?php } ?>
